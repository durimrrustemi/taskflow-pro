...
const { validateTask, validateQueryParams } = require('../middleware/validation');
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get('/', authenticate, validateQueryParams, taskController.getAllTasks);
...
router.patch('/:id', authenticate, taskController.partialUpdateTask);
